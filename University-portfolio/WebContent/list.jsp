		...
		<c:choose>
			...
			<c:otherwise>
				...
				<tr>
					...
					<td>${vo.subjectnum }</td>
					<td>
						<a class="vieew" href="Controller?type=CB_View&b_idx=${vo.b_idx }&cPage=${pvo.nowPage}">${vo.title }</a>
					</td>
					<td>${vo.writer }</td>
...
<div class="ps">
	<ol class="paging">
		<li><a href="Controller?type=CR_BBS&cPage=1"> << </a></li>
		<c:choose>
			...
			<c:otherwise>
				<li>
					<a href="Controller?type=CR_BBS&cPage=${pvo.beginPage - 1 }"> < </a>
				</li>
			</c:otherwise>
		</c:choose>
		...
		<c:choose>
			...
			<c:otherwise>
				<li><a href="Controller?type=CR_BBS&cPage=${pvo.endPage + 1 }"> > </a></li>
			</c:otherwise>
		</c:choose>
		<li><a href="Controller?type=CR_BBS&cPage=${pvo.totalPage} "> >> </a></li>
	</ol>
</div>
</div>
<div id="footer">
