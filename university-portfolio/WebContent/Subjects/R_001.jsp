...
<div class= "wrap">
    ...
    <table class="table"> 
        ...
        <tr>
            <td colspan="2">
            	<p class="photo"><img src="img/원윤희강사님.gif" width="1200px" height="800px" alt="강사사진"></p>
            </td>
        </tr>
        <tr>
        ...
        <tfoot>
        <tr>
            <td colspan="2" class="inform"><img src="img/놀이지도계획서.PNG" width="1200px" height="1000px" alt="강사사진"></td>
        </tr>
        </tfoot>
    </table>
</div>
