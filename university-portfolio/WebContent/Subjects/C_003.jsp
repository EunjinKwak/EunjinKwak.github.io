...
<div class= "wrap">
    ...
    <table class="table"> 
        ...
        <tr>
            <td colspan="2">
            	<p class="photo"><img src="img/이상민.jpg" width="800px" height="600px" alt="강사사진"></p>
            </td>
        </tr>
        <tr>
        ...
        <tfoot>
        <tr>
            <td colspan="2" class="inform"><img src="img/생활과경제계획서.PNG" width="1200px" height="1000px" alt="강사사진"></td>
        </tr>
        </tfoot>
    </table>
</div>
